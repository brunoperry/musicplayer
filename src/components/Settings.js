...
export default class Settings extends Component{
    ...
    buildView() {
        ...
        this.#playmodeButton = new ToggleButton(pmData.name, pmData.value, ['repeat_all', 'repeat_current', 'shuffle']);
    ...
    async show() {
        this.element.dispatchEvent(new CustomEvent(Settings.ACTION, {detail: {type:Settings.Actions.OPENING}}));
    ...
    async hide() {
        this.element.dispatchEvent(new CustomEvent(Settings.ACTION, {detail: {type:Settings.Actions.CLOSING }}));
    ...
    static get ACTION() {return 'settingsaction'}
