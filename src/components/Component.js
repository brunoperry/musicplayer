...
export default class Component {
    ...
    set id(val) {this.#elem.setAttribute('id', val)} 
    get id() {return this.#elem.getAttribute('id')}

    set width(val) { this.#elem.style.width = `${val}px` }
    ...
    set element(elem) {this.#elem = elem;}
}