...
export default class Controls extends Component {
    ...
    constructor() {
        ...
        this.#previousButton = new IconButton(['previous']);
        this.#previousButton.addEventListener('click', () => {
            elem.dispatchEvent(new CustomEvent(Controls.States.ON_ACTION, {
                detail: {
        ...
        this.#playPauseButton = new IconButton(['play', 'pause', 'loading', 'cross']);
        ...
        this.#nextButton = new IconButton(['next']);
        this.#nextButton.addEventListener('click', () => {
            this.element.dispatchEvent(new CustomEvent(Controls.States.ON_ACTION, {
                detail: {
